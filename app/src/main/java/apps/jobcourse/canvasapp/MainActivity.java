package apps.jobcourse.canvasapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Paint mPaintText = new Paint(Paint.UNDERLINE_TEXT_FLAG); //untuk mewarnai text di kotaknya
